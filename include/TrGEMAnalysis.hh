...
class TrGEMAnalysis {
	...
	public:
		...
		void SaveDriftRegion(std::string pProcess, G4bool flag, G4int index);
	...
	private:
		...
		std::vector<std::string>* pdriftProcess;
		std::vector<std::string> driftProcessS;
		std::vector<std::string>* pdriftProcessS;
		std::vector<std::string> driftProcessW;
		std::vector<std::string>* pdriftProcessW;
